  ...
  return (
    <div className="min-h-screen bg-[#1C1C1E] text-[#F5F5F7] selection:bg-[#8B7FDE]/20 selection:text-[#8B7FDE] transition-colors duration-300 font-sans">
      ...
      <section className="relative max-w-5xl mx-auto px-6 py-24 md:py-32 flex flex-col items-center text-center space-y-12 overflow-hidden">
        ...
        <div className="space-y-6 max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-[#A0A0A0] leading-relaxed max-w-2xl mx-auto font-medium">
            Magda is a voice-first AI planner that turns natural speech into structured tasks without breaking your flow.
          </p>
        </div>
      ...
      <section className="bg-[#18181a] py-32 border-y border-white/5">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-3xl md:text-5xl font-black text-white">Zen Productivity</h2>
            <p className="text-[#A0A0A0] text-lg max-w-xl mx-auto">Designed for calm, focused minds who value speed and simplicity.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group bg-[#2C2C2E] p-10 rounded-[2.5rem] border border-white/5 transition-all hover:translate-y-[-8px] hover:border-[#8B7FDE]/30">
                <div className="text-5xl mb-6 grayscale group-hover:grayscale-0 transition-all duration-500">{item.emoji}</div>
                <h3 className="text-2xl font-black mb-4 text-white">{item.title}</h3>
                <p className="text-[#A0A0A0] leading-relaxed font-medium">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 max-w-5xl mx-auto px-6">
        <div className="text-center mb-20 space-y-4">
          <h2 className="text-3xl md:text-5xl font-black text-white">The Pioneer Plan</h2>
          <p className="text-[#A0A0A0] text-lg font-medium">Join the early wave of voice-first builders.</p>
        </div>
        ...
        <div className="max-w-md mx-auto">
          <div className="relative p-12 rounded-[3rem] border-2 border-[#8B7FDE] shadow-[0_30px_60px_rgba(0,0,0,0.5)] flex flex-col space-y-10 bg-[#2C2C2E]">
            ...
            <div className="space-y-3">
              ...
              <p className="text-[#8B7FDE] font-bold">Lock in early-adopter pricing forever.</p>
            </div>
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={i} className="flex items-center gap-4 text-white/90 font-medium">
                  <span className="text-[#8B7FDE] text-xl font-black">✓</span> {f}
                </li>
              ))}
            </ul>
      ...
      <section id="waitlist" className="bg-[#18181a] py-32 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-6 text-center space-y-12">
          <div className="space-y-4">
            <h2 className="text-3xl md:text-4xl font-black text-white">Magda is in private development</h2>
            <p className="text-[#A0A0A0] text-lg font-medium">
              We're building the future of scheduling. Join the waitlist to be among the first to experience it.
            </p>
          </div>
          ...
          <div className="bg-[#2C2C2E] p-2 rounded-3xl border border-white/5 shadow-2xl overflow-hidden min-h-[300px] flex items-center justify-center">
            ...
            <div className="text-center p-8 space-y-4">
              <p className="text-[#A0A0A0]">Waitlist form will be integrated here.</p>
              <div className="w-full h-[150px] border border-dashed border-white/10 rounded-2xl flex items-center justify-center opacity-30">
                <span className="text-xs uppercase tracking-widest font-black">Form Placeholder</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="py-24 border-t border-white/5 bg-[#1C1C1E]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col items-center gap-12">
          <div className="flex items-center gap-4 font-black text-2xl text-white">
            <img src="/magda-icon.png" alt="Magda" className="w-12 h-12 rounded-2xl shadow-xl" />
            <span>Magda</span>
          </div>
          
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-6 text-sm font-bold">
            <Link href="/legal/magda/privacy" className="text-[#A0A0A0] hover:text-[#8B7FDE] transition-colors underline underline-offset-8 decoration-white/5 hover:decoration-[#8B7FDE]">Privacy Policy</Link>
            <Link href="/legal/magda/terms" className="text-[#A0A0A0] hover:text-[#8B7FDE] transition-colors underline underline-offset-8 decoration-white/5 hover:decoration-[#8B7FDE]">Terms of Service</Link>
          </div>
          ...
          <p className="text-[#666666] text-xs font-medium">© {new Date().getFullYear()} EchoForge. All rights reserved.</p>
        </div>
      </footer>
